...
class UIkit {
    ...
    * @since 1.0.0
    */
    public static function position_corners_top_bottom() {
        return array(
            'uk-position-top' => __('Top', 'suprementor'),
            'uk-position-bottom' => __('Bottom', 'suprementor'),
            'uk-position-top-left' => __('Top Left', 'suprementor'),
    ...
    * @since 1.0.0
    */
    public static function columns_mobile() {
        return array(
            'uk-width-1-1' => __('1', 'suprementor'),
            'uk-width-1-2' => __('2', 'suprementor'),
            'uk-width-1-3' => __('3', 'suprementor'),
            'uk-width-1-4' => __('4', 'suprementor'),
            'uk-width-1-5' => __('5', 'suprementor'),
            'uk-width-1-6' => __('6', 'suprementor'),
        );
    }
    ...
    * @since 1.0.0
    */
    public static function columns_tablet() {
        return array(
            'uk-width-1-1@s' => __('1', 'suprementor'),
            'uk-width-1-2@s' => __('2', 'suprementor'),
            'uk-width-1-3@s' => __('3', 'suprementor'),
            'uk-width-1-4@s' => __('4', 'suprementor'),
            'uk-width-1-5@s' => __('5', 'suprementor'),
            'uk-width-1-6@s' => __('6', 'suprementor'),
        );
    }
    ...
    * @since 1.0.0
    */
    public static function columns_desktop() {
        return array(
            'uk-width-1-1@m' => __('1', 'suprementor'),
            'uk-width-1-2@m' => __('2', 'suprementor'),
            'uk-width-1-3@m' => __('3', 'suprementor'),
            'uk-width-1-4@m' => __('4', 'suprementor'),
            'uk-width-1-5@m' => __('5', 'suprementor'),
            'uk-width-1-6@m' => __('6', 'suprementor'),
        );
    }
