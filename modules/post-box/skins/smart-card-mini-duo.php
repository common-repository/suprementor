...
class Smart_Card_Mini_Duo extends \Elementor\Skin_Base {

    /**
    * Get skin ID.
    */
    public function get_id() {
        return 'smart_card_mini_duo';
    }
    ...
    */
    public function get_title() {
        return __( 'Smart - Card Mini Duo', 'suprementor' );
    }
    ...
    */
    public function render() {
        ...
        <?php \Suprementor\Controls\Post\Responsive_Thumbnail_Duo::render( $settings, $post_id ); ?>
