...
class Smart_Boxed_Cover extends \Elementor\Skin_Base {
    ...
    */
    public function get_title() {
        return __( 'Smart - Boxed Cover', 'suprementor' );
    }
                ...
                <?php while ( have_posts() ) : ?>
                    ...
                    <div class="sup-height-match <?php echo esc_attr( implode( ' ', $settings['sup_columns_classes'] ) ); ?>">
                        ...
                        <div class="sup-cover-container uk-cover-container uk-position-relative">
                            ...
                            <div class="sup-cover sup-cover-wrap sup-cover-overlay sup-post-box-inner uk-overflow-hidden <?php echo esc_attr( implode( ' ', \Suprementor\Controls\Cover::wrapper_classes( $settings ) ) ); ?>" style="pointer-events: none;">
